...
public class EmailParameter
{
    ...
    // does not work with both only with one top 2 or below function
...
public class EmailServer
{
    ...
    SmtpClient Smtp()
    {
        // not required if it is defined in web.config; or: new SmtpClient("mail.server.com",25); ("127.0.0.1")
        SmtpClient sm = new SmtpClient(Utils.AppSetting("EmailServerHost"), 25);
